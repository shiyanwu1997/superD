...
import { setUserProjectPermission, removeUserProjectPermission, addUserProgramPermission, removeUserProgramPermission, getUserProgramPermissions, getProgramsByProject, deleteUser, updateUserCreatedBy, approveUser } from '../../utils/api';
      ...
      render: (_, record) => {
        ...
        return (
          <Space>
            ...
            <Popconfirm title={isPending ? '拒绝该注册申请（删除此用户记录）？' : '确定删除此用户？'} onConfirm={async () => {
